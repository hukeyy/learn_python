...
__db_main = os.path.join(BASE_DIR, 'main_dict')
...
class Course(object):
    ...
    def cat_course(self):
        print('\033[32;1m课程：【%s】\t价格：【%s元】\t周期：【%s个月】' %(self.name, self.price, self.time))
...
class Grade(object):
    ...
    def add_student(self, student_name, dic, teacher, file):
        self.student.add(student_name)
        dic[teacher] = {'grade': self}
    ...
    while Flag:
        ...
        if school_name in res_school:
            ...
            while Flag:
                ...
                if choice == '1':   # 创建课程
                    while True:
                        print('\033[33;1m学校【%s】目前已经的课程信息:\033[0m' % school_name)
                    ...
                    while True:
                        print('\033[33;1m学校【%s】目前已存在的讲师信息：\033[0m' % school_name)
                        ...
                        if if_cont == 'y':
                            ...
                            course_name = input('\033[34;1m输入讲师课程：\033[0m').strip()
                            if course_name in res_course:
                                ...
                                if teacher_name not in res_teacher:
                                    ...
                                    print('\033[31;1m输入的讲师名已存在.\033[0m')
                    ...
                    while True:
                        ...
                        print('\033[33;1m学校【%s】目前已存在的班级信息：\033[0m' % school_name)
                        res_course = information(main_db[school], 'None')[0]
                        if res_course:
                            for i in res_course:
                                k = res_course[i]
                        ...
                        if if_cont == 'y':
                            ...
                            if course_name in res_course:
                                ...
                                print('\033[31;1m输入的课程信息不存在.\033[0m')
                        elif if_cont == 'b':
                            break
                        else:
                            print('\033[31;1m输入错误，请重新输入.\033[0m')
